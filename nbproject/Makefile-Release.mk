...
${OBJECTDIR}/src/BlockStatus.o: src/BlockStatus.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BlockStatus.o src/BlockStatus.cpp

${OBJECTDIR}/src/WriteBuffer.o: src/WriteBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WriteBuffer.o src/WriteBuffer.cpp

${OBJECTDIR}/src/blockio.o: src/blockio.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/blockio.o src/blockio.cpp

${OBJECTDIR}/src/imgcopy3.o: src/imgcopy3.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/imgcopy3.o src/imgcopy3.cpp
...
${OBJECTDIR}/src/BlockStatus_nomain.o: ${OBJECTDIR}/src/BlockStatus.o src/BlockStatus.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BlockStatus_nomain.o src/BlockStatus.cpp;\
	else  \
...
${OBJECTDIR}/src/WriteBuffer_nomain.o: ${OBJECTDIR}/src/WriteBuffer.o src/WriteBuffer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WriteBuffer_nomain.o src/WriteBuffer.cpp;\
	else  \
...
${OBJECTDIR}/src/blockio_nomain.o: ${OBJECTDIR}/src/blockio.o src/blockio.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/blockio_nomain.o src/blockio.cpp;\
	else  \
...
${OBJECTDIR}/src/imgcopy3_nomain.o: ${OBJECTDIR}/src/imgcopy3.o src/imgcopy3.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/imgcopy3_nomain.o src/imgcopy3.cpp;\
	else  \
